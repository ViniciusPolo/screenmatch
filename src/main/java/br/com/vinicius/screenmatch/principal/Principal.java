...
import br.com.vinicius.screenmatch.model.Episodio;
...
//                .limit(10)
//                .peek(e -> System.out.println("Terceiro Filtro (Limitador)" + e))
...
//
        ...
        if(episodioBuscado.isPresent()){
            ...
            System.out.println("Não há referências para esse episódio.");
        }
